♥This file （Kaggle_eff.ipynb） is the baseline code for kaggle kaggle-Global Wheat Detection

Kaggle_eff.ipynb文件是kaggle-Global Wheat Detection（kaggle全球小麦检测）比赛的baseline代码
